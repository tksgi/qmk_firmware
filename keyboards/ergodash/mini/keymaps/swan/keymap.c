...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_Q,    KC_W,    KC_E,          KC_R,    KC_T,           KC_LPRN,  KC_RPRN, KC_Y,          KC_U,   KC_I,    KC_O,    KC_P,    KC_EQL,  \
    KC_TAB,  KC_A,    KC_S,    KC_D,          KC_F,    KC_G,           KC_LBRC,  KC_RBRC, KC_H,          KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,          KC_V,    KC_B,           KC_NO ,   KC_NO ,  KC_N,          KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_MINS, \
    KC_LCTL, KC_NO,   KC_LGUI, LALT_T(KC_F5), KC_BSPC, LSFT_T(KC_SPC), CALC,     CUSL,    LCTL_T(KC_ENT), KC_DEL, KC_F12,  KC_APP,  KC_QUES, KC_MINS  \
  ),
  ...
  _______, KC_TILD, KC_HOME,    KC_PGDN, KC_END,     KC_LPRN, _______,    _______, KC_RPRN, KC_LEFT,      KC_DOWN, KC_RGHT,      KC_PIPE, KC_F11,  \
  ...
  */
  ...
  _______, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_LBRC, _______,     _______, KC_RBRC, KC_4,    KC_5,    KC_6,    KC_TILD, _______, \
  _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_EXLM, KC_LCBR, _______,     _______, KC_RCBR, KC_1,    KC_2,    KC_3,    KC_PEQL, _______, \
  _______, _______, _______, _______, _______, _______, _______,     ADJUST,  KC_0,    _______, _______, _______, _______, _______  \
    ),
