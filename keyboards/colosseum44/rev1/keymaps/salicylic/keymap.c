...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_Z,    KC_X,     KC_C,   KC_V,    KC_B,                    KC_N,   KC_M,  KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS,
                   KC_LGUI, KC_RAISE, KC_SPC, KC_BSPC,                  KC_DEL, KC_ENT, KC_LOWER, KC_LALT
  ),
    /* Lower
     */
  [_LOWER] = LAYOUT(
 KC_ESC, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                   KC_CIRC, KC_AMPR,   KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                   KC_MINS,  KC_EQL,   KC_LCBR, KC_RCBR, KC_PIPE,  KC_GRV,
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                   KC_UNDS, KC_PLUS,   KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD,
                  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_ADJUST, KC_TRNS
  ),
    /* Raise
     */
  ...
  KC_LSFT, KC_F1,   KC_F2,     KC_F3,   KC_F4,   KC_F5,                 KC_LEFT, KC_DOWN,    KC_UP, KC_RGHT,   KC_NO,   KC_NO,
  KC_LCTL, KC_F6,   KC_F7,     KC_F8,   KC_F9,  KC_F10,                  KC_F11,  KC_F12,  KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS,
                  KC_TRNS, KC_ADJUST, KC_TRNS, KC_TRNS,                 KC_TRNS, KC_TRNS, KC_RAISE, KC_TRNS
  ),
  ...
  [_ADJUST] = LAYOUT(
   ...
   RGB_RMOD, RGB_HUD, RGB_SAD,  RGB_VAD, RGB_SPD, KC_VOLD,              KC_ACL0, KC_ACL1,  KC_ACL2,   KC_NO,   KC_NO,   KC_NO,
                      KC_TRNS, KC_RAISE, KC_TRNS, KC_TRNS,              KC_TRNS, KC_TRNS, KC_LOWER, KC_TRNS
          )
};
